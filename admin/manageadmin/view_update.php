...
<article class="content container">
    <div class="col-sm-10">
        <div class="you-right mx-5 pb-4">
            <h5 class="pt-4 pb-2 px-4"> UPDATE INFORMATION ADMIN</h5>
            <hr>
            <form class="px-4" action="process_update.php" method="POST">
            	<input type="hidden" name="idAdmin" value="<?php echo $each['idAdmin']  ?>">
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div  class="col-sm-10">
                        <input type="Email" class="form-control col-sm-7" id="email" name="email" onkeyup="myfunction()" value="<?php echo $each['email'] ?>">
                 ...
                 <div class="form-group row">
                    ...
                    <div  class="col-sm-10">
                        <input type="text" class="form-control col-sm-7" id="password" name="password" onkeyup="myfunction()" value="<?php echo $each['password'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div  class="col-sm-10">
                        <input type="text" class="form-control col-sm-7" id="numberPhone" name="numberPhone" onkeyup="myfunction()" value="<?php echo $each['numberPhone'] ?>">
               ...
               <div class="form-group row">
                    ...
                    <div  class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="sex" id="sex1" value="1" <?php if($each['sex']==1) echo 'checked'; ?>>
                            <label class="form-check-label" for="sex1">
                            Female
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="sex" id="sex0" value="0" <?php if($each['sex']==0) echo'checked'; ?>>
                ...
                <div class="form-group row">
                 ...
                 <button type="submit" class="btn btn-info" id="btn">Update Admin</button>
            </form>
        </div>
    </div>
